...
MATRIX="${ROOT}/configs/dt_ldp_far/stage23_robust_admissibility_validation.yaml"
OUTPUT="${ROOT}/results/dt_ldp_far/stage23_robust_admissibility_validation_v1"
LOG_DIR="${ROOT}/logs/dt_ldp_far"
LOG_FILE="${LOG_DIR}/stage23_robust_admissibility_validation_mps.log"
