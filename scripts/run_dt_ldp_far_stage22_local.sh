...
MATRIX="${ROOT}/configs/dt_ldp_far/stage22_lagged_descent_validation.yaml"
OUTPUT="${ROOT}/results/dt_ldp_far/stage22_lagged_descent_validation_v1"
LOG_DIR="${ROOT}/logs/dt_ldp_far"
LOG_FILE="${LOG_DIR}/stage22_lagged_descent_validation_mps.log"
