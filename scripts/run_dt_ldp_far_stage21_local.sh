...
MATRIX="${ROOT}/configs/dt_ldp_far/stage21_ipm_specific_confirmatory.yaml"
OUTPUT="${ROOT}/results/dt_ldp_far/stage21_ipm_specific_confirmatory_v1"
LOG_DIR="${ROOT}/logs/dt_ldp_far"
LOG_FILE="${LOG_DIR}/stage21_ipm_specific_confirmatory_mps.log"
