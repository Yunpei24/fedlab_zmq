...
MATRIX="${ROOT}/configs/dt_ldp_far/stage20a_fmnist_rfa_support_screen.yaml"
OUTPUT="${ROOT}/results/dt_ldp_far/stage20a_fmnist_rfa_support_screen_v1"
LOG_DIR="${ROOT}/logs/dt_ldp_far"
LOG_FILE="${LOG_DIR}/stage20a_fmnist_rfa_support_mps.log"
